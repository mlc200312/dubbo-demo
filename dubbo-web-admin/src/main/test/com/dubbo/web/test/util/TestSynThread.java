...
public class TestSynThread implements Runnable {

	private ExampleService exampleService;
	private RedisTemplate<String, Object> redisTemplate;
	private String name;

	public TestSynThread(ExampleService exampleService, RedisTemplate<String, Object> redisTemplate, String name) {
		super();
